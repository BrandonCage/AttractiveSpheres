...
//Preallocate memory
	...
	double syc1=.3*L;//Sphere 1 y center
	double sr1=.01*radius*L;//Sphere 1 radius


	//sphere2
	double sxc2=.5*L;//Sphere 2 x center
	double syc2=.7*L;//Sphere 2 y center
	double sr2=.04*.04*L*L/sr1;//Sphere 2 radius
